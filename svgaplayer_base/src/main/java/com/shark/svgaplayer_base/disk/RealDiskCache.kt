package com.shark.svgaplayer_base.disk

import com.shark.svgaplayer_base.disk.DiskCache.Editor
import com.shark.svgaplayer_base.disk.DiskCache.Snapshot
...
internal class RealDiskCache(
    ...
    private class RealSnapshot(private val snapshot: DiskLruCache.Snapshot) : Snapshot {
        ...
        override fun closeAndEdit() = snapshot.closeAndEdit()?.let(RealDiskCache::RealEditor)
    }
    ...
    private class RealEditor(private val editor: DiskLruCache.Editor) : Editor {
        ...
        override fun commitAndGet() = editor.commitAndGet()?.let(RealDiskCache::RealSnapshot)
